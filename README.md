...
* It is recommended to complete all the courses in Fundamentals, Mandatory Theory and Math Required to support your course
* Try to complete 3 learning paths
* It is recommended to learn at least 2 languages from the programming section
* It is recommended to do a major project in each learning path

Note: All the courses are selected such that it is possible to obtain a free certificate (as far as possible). If you want to dwell deeper, look for online materials and courses at Coursera

# Fundamentals

| Subject                                 | Course                                                       | Platform                   |
| --------------------------------------- | ------------------------------------------------------------ | -------------------------- |
| Computer Science 101                    | https://lagunita.stanford.edu/courses/Engineering/CS101/Summer2014/about | Stanford OpenEdx           |
| Programming in C                        | https://www.udemy.com/zombie-code-how-to-be-infected-by-c-code-c-virus/ https://www.coursera.org/specializations/c-programming | Udemy, Coursera (optional) |
| Data Structures and Algorithms          | https://www.udemy.com/introduction-to-algorithms-and-data-structures-in-c/ https://www.udemy.com/introduction-to-data-structures/ | Udemy                      |
| Logic and Boolean Algebra               | https://www.udemy.com/pure-mathematics-for-beginners-lesson-1-logic/ | Udemy                      |
| Linux and Shell Scripting               | https://www.datacamp.com/courses/introduction-to-shell-for-data-science | DataCamp                   |
| Introduction to World Wide Web          | https://www.udemy.com/introduction-to-networking-for-complete-beginners/ | Udemy                      |
| Object Oriented Programming in C++/Java | https://www.udemy.com/java-tutorial/                         | Udemy                      |

## Mandatory Theory

| Subject                                | Course                                                       | Platform         |
| -------------------------------------- | ------------------------------------------------------------ | ---------------- |
| Computer Organization and Architecture | https://learn.saylor.org/course/view.php?id=71               | Saylor Academy   |
| Theory of Computation                  | https://lagunita.stanford.edu/courses/course-v1:ComputerScience+Automata+SelfPaced/about | Stanford OpenEdx |
| Operating Systems and System Software  | https://learn.saylor.org/course/view.php?id=94               | Saylor Academy   |

# Learning Paths

* It is recommended to choose 2 or 3 learning paths according to your interest

Networking

| Subject                                              | Course                                                       | Platform                  |
| ---------------------------------------------------- | ------------------------------------------------------------ | ------------------------- |
| Basics of Networking                                 | https://www.udemy.com/introduction-to-networking-for-complete-beginners/ https://www.open.edu/openlearn/science-maths-technology/it-device-device-communication/content-section-0?active-tab=content-tab | Udemy, Open University    |
| Network Layer, Transport Layer and Application Layer | https://www.coursera.org/learn/computer-networking           | Coursera                  |
| Wireless and Multimedia Networks                     | https://www.coursera.org/learn/wireless-communications       | Coursera                  |
| Cyber Security                                       | https://www.open.edu/openlearn/science-maths-technology/introduction-cyber-security-stay-safe-online/content-section-overview?active-tab=content-tab Video Materials: https://www.coursera.org/learn/software-security?specialization=cyber-security https://www.coursera.org/learn/cryptography?specialization=cyber-security | Open University, Coursera |
| Internet Of Things                                   | https://www.udemy.com/unpacking-the-internet-of-things/ https://www.open.edu/openlearn/science-maths-technology/internet-everything/content-section-overview?active-tab=content-tab | Open University, Udemy    |
| Elective: Blockchain                                 | https://cognitiveclass.ai/courses/blockchain-course/         | Cognitive Class           |
